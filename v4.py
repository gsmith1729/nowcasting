...
short_var = ['ACOGNO','ACOGNO','ANDENOx.x','TWEXAFEGSMTHx.x','UMCSENTx.x','OUTMS','TCU','LNS13023621','LNS13023557','LNS13023705','LNS13023569','AWHNONAG','ACOGNOx','ANDENOx.y','INVCQRMTSPL','WPU0531','AHETPIx','COMPRMS','OPHMFG','ULCMFG','MORTGAGE30US','MORTG10YRx','REVOLSLx','DRIWCIL',  'USSTHPI','SPCS10RSA', 'SPCS20RSA', 'TWEXAFEGSMTHx.y', 'EXUSEU', 'USEPUINDXM', 'GFDEGDQ188S',  'GFDEBTNx',  'NASDAQCOM',  'CUSR0000SEHC']
...
endog_vars=monthly_var+["GDPC1"]#=df.columns
...
mod=sm.tsa.DynamicFactorMQ(endog, k_endog_monthly=monthly, factors=1, factor_multiplicities=7, factor_orders=1, idiosyncratic_ar1=False)#, standardization=False)
res=mod.fit()
